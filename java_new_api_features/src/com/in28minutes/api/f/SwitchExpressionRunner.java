...
public class SwitchExpressionRunner {
    ...
    //new Version of switch, no fallthrough
    public static String findDayOfTheWeekWithSwitchExpressions(int day){
    ...
    public static void main(String[] args) {
        String day=findDayOfTheWeekWithSwitchExpressions(0);
